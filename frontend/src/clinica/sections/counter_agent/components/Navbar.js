                ...
                <nav className="navbar navbar-expand-lg custom-navbar">
                    ...
                    >
                        <ul className="navbar-nav py-2">
                            ...
                            <li className="nav-item">
                                <Link
                                    className={`nav-link ${activePage === "/alo24/statsionar_doctors_report" ? "active-page" : ""
                                        }`}
                                    onClick={() => {
                                        setActivePage('/alo24/statsionar_doctors_report')
                                    }}
                                    to="/alo24/statsionar_doctors_report"
                                    style={{ background: activePage === "/alo24/statsionar_doctors_report" ? "#F97316" : "" }}
                                >
                                    <i className="icon-devices_other nav-icon" />
                            ...
                            <li className="nav-item">
                                <Link
                                    className={`nav-link ${activePage === "/alo24/visit_page" ? "active-page" : ""
                                        }`}
                                    onClick={() => {
                                        setActivePage('/alo24/visit_page')
                                    }}
                                    to="/alo24/visit_page"
                                    style={{ background: activePage === "/alo24/visit_page" ? "#F97316" : "" }}
                                >
                                    <i className="icon-devices_other nav-icon" />
                                    {t("Tashrif")}
                                </Link>
